...
const AIContent: React.FC = () => {
  ...
  const generateContent = async () => {
    if (!prompt.trim() || !user) {
      alert('Lütfen içerik konusu girin.');
      return;
    }
    ...
    console.log('[AI_CONTENT] Generating content for platform:', platform);
    setLoading(true);
    ...
    try {
      ...
      console.log('[AI_CONTENT] Content generated and saved successfully');
    } catch (error) {
